...
x = 5 + 3; 
/*
Semántica de suma y asignación: el compilador interpreta que debe calcular la 
suma de `5 + 3`, asignar el valor `8` a la variable `x`, y reservar un espacio  en memoria para guardar ese valor
*/
...
![[DiagFlujoBloqueSecuencia.png]]*Diagrama de flujo*
...
- Empezar con pseudo-código de alto nivel y refinar pasos “obvios” en subrutinas hasta llegar a operaciones primitivas.
