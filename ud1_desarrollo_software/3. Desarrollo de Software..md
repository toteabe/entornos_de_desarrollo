...
El proceso de desarrollo, que en un principio puede parecer una tarea simple, consta de una serie de pasos de *obligado cumplimiento*, pues sólo así podremos garantizar que los
...
| -------------------- | ------------------------------------------------------------------------ | ----------------------------------------------------------- |
| **1. Análisis**      | Identificación y comprensión de los requisitos del sistema.              | Saber qué necesita el usuario y qué debe hacer el software. |
| **2. Diseño**        | Planificación técnica de la solución: arquitectura, módulos, interfaces. | Definir cómo se construirá el software.                     |
...
| **6. Explotación**   | Puesta en marcha del software en el entorno real.                        | Que los usuarios puedan utilizar el software.               |
...
Ya hemos visto que la serie de pasos a seguir para desarrollar un programa es lo que se conoce como Ciclo dee Vida del Software.
...
Metáforas para interpretación del modelo iterativo incremental:
